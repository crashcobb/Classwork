...
public class PlayerController : MonoBehaviour
{
    ...
    void Shoot()
    {
        ...
        {
            GameObject.Instantiate(this.bullet, this.transform.position, transform.rotation);
        }
    }
    ...
    void boundMovement()
    {
        ...
        this.transform.position = new Vector3(
            Mathf.Clamp(this.transform.position.x, leftBorder + playerSize.x / 2,
            rightBorder - playerSize.x / 2), Mathf.Clamp(this.transform.position.y,
            topBorder + playerSize.y / 2, bottomBorder - playerSize.y / 2),
